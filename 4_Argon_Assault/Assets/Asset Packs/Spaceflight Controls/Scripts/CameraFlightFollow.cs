...
public class CameraFlightFollow : MonoBehaviour {
    ...
    {        
        ...
        Vector3 thirdPos = target.TransformPoint(control.yaw * yawMultiplier, camera_elevation, -follow_distance);
        ...
        if (control.afterburner_Active && shake_on_afterburn)
        {
            ...
            newRotation = Quaternion.LookRotation(thirdDiff + new Vector3(
